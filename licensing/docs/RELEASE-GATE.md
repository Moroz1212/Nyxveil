# Control Plane release gate (1.3.8)

Release artifact: `Nyxveil-ControlPlane-v1.3.8-release.zip`
...
Schema remains at 5. No new migration for 1.3.8. Self-update durable state lives under
