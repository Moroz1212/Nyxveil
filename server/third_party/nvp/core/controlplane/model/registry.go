...
type NodeRegistryEntry struct {
	...
	SPKIPin         []byte               `json:"spki_pin,omitempty"` // SHA-256 of TLS cert SPKI (not ServerIdentityKey)
...
// NodeHealth is the dynamic health payload for UpdateNodeHealth (alias of HealthInfo).
type NodeHealth = HealthInfo
