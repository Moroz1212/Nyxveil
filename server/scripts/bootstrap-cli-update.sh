...
#
# Usage (production):
#   sudo bash bootstrap-cli-update.sh --version 1.1.11 --then-update
#
# Offline:
...
VERSION="${NYXVEIL_BOOTSTRAP_VERSION:-1.1.11}"
...
Usage: bootstrap-cli-update.sh [options]
  ...
  --version X.Y.Z     Target release version (default 1.1.11)
